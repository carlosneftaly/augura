...
## Qué son R y R-studio? 

El término "`R`" es usado para referirse tanto al lenguaje de programación y 
el software que interpreta los _scripts_ escritos usándolo. 



[RStudio](https://rstudio.com) es quizá la [IDE](https://es.wikipedia.org/wiki/Entorno_de_desarrollo_integrado) más popular para escribir código en "`R`". Para funcionar correctamente, Rstudio necesita una instalación actualizada de "`R`" instalada en el computador. 
